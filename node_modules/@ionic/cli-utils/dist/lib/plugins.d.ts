...
export declare function loadPlugins(env: IonicEnvironment): Promise<(() => Promise<void>) | undefined>;
export declare function loadPlugin(env: IonicEnvironment, pluginName: string, {message, askToInstall, reinstall}: {
    message?: string;
