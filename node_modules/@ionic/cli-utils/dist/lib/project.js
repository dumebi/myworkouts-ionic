...
exports.PROJECT_TYPES_PRETTY = new Map([
    ...
    determineType() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            throw new errors_1.FatalException(`Could not determine project type.\n\n`
                + `For ${exports.PROJECT_TYPES_PRETTY.get('ionic-angular')} projects, make sure 'ionic-angular' exists in the ${chalk.bold('dependencies')} attribute of ${chalk.bold('package.json')}.\n`
                + `For ${exports.PROJECT_TYPES_PRETTY.get('ionic1')} projects, make sure 'ionic' exists in the ${chalk.bold('devDependencies')} attribute of ${chalk.bold('bower.json')}.\n\n`
